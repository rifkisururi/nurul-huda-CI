    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Tagihan Master Add</h3>
            </div>
            <?php echo form_open('tagihan_master/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						<label for="nama_tagihan" class="control-label"><span class="text-danger">*</span>Nama Tagihan</label>
						<div class="form-group">
							<input type="text" name="nama_tagihan" value="<?php echo $this->input->post('nama_tagihan'); ?>" class="form-control" id="nama_tagihan" />
