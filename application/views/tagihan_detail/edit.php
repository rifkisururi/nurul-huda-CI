    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Tagihan Detail Edit</h3>
            </div>
			<?php echo form_open('tagihan_detail/edit/'.$tagihan_detail['id']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="id_tagihan_master" class="form-control">
								...
								{
									$selected = ($tagihan_master['id'] == $tagihan_detail['id_tagihan_master']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="status_pembayaran" class="form-control">
								...
								{
									$selected = ($value == $tagihan_detail['status_pembayaran']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="id_santri" class="form-control">
								...
								{
									$selected = ($santri['id'] == $tagihan_detail['id_santri']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="jumlah" value="<?php echo ($this->input->post('jumlah') ? $this->input->post('jumlah') : $tagihan_detail['jumlah']); ?>" class="form-control" id="jumlah" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="id_pengurus" class="control-label">Id Pengurus</label>
						<div class="form-group">
							<input type="text" name="id_pengurus" value="<?php echo ($this->input->post('id_pengurus') ? $this->input->post('id_pengurus') : $tagihan_detail['id_pengurus']); ?>" class="form-control" id="id_pengurus" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="tanggal" class="control-label"><span class="text-danger">*</span>Tanggal</label>
						<div class="form-group">
							<input type="text" name="tanggal" value="<?php echo ($this->input->post('tanggal') ? $this->input->post('tanggal') : $tagihan_detail['tanggal']); ?>" class="form-control" id="tanggal" />
